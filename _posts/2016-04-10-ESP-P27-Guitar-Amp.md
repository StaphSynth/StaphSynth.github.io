...
comments: true
modified: 2016-09-15
image: /assets/images/P27-struct-mock.jpg
tags:
  - electronics
  - amplifiers
  - guitar
...
{% include image.html url="/assets/images/P27-mock-up.jpg" caption="Test-fit to make sure the case was going to fit with the heatsink as designed" %}
...
{% include image.html url="/assets/images/P27-struct-mock.jpg" caption="Mock-up of the major modules in the case. The transformer is complete overkill - it could have been almost half the size - but it was left over from a different project I decided to scrap." %}
...
{% include image.html url="/assets/images/P27-shielded.jpg" caption="The chassis panels with shielding applied. The aluminium strips on the side panels are load-bearing washers to which the M6 bolts apply force. Since the holes for the bolts are recessed, the timber would crack under repeated strain without them." %}
...
{% include image.html url="/assets/images/P27-aligning-sides.jpg" caption="Aligning the sides and bottom-piece brackets before permanently attaching the top to the sides. I had to use folded pieces of aluminium foil as shims for fine adjustment of the angle." %}
...
{% include image.html url="/assets/images/P27-clamped.jpg" caption="Top doweled and glued to the sides. Clamped overnight while the glue set."%}
...
{% include image.html url="/assets/images/P27-stained.jpg" caption="Stain before protective coating. The small holes in the bottom are for ventilation. The big one is for the transformer mounting plate." %}
...
{% include image.html url="/assets/images/P27-shellac.jpg" caption="The bottom after a good shellacing. Also with rubber feet! :)" %}
