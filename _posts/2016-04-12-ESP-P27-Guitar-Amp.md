...
comments: true
modified: 2016-09-15
image: /assets/images/P27-complete-front.jpg
tags:
  - electronics
  - amplifiers
  - guitar
...
{% include image.html url="/assets/images/P27-internals-prewire.jpg" caption="Another test-fit of the internals. The bridge rectifier is mounted to an old CPU heatsink that is itself bolted to the shield. It's far larger than necessary, but I had it handy, so why not?" %}
...
{% include image.html url="/assets/images/P27-panel-gaps.jpg" caption="The brackets to hold the panels are made from more aluminium angle stock." %}
...
{% include image.html url="/assets/images/P27-precision-grinder.jpg" caption="Why yes, the 'precision grinding tool' <i>is</i> a hand-held belt sander in a bench vice. Why you you ask? :)" %}
...
{% include image.html url="/assets/images/P27-panels-flush.jpg" caption="Like a glove :)" %}
...
{% include image.html url="/assets/images/P27-rear-panels-complete.jpg" caption="The rear panels turned out really well." %}
...
{% include image.html url="/assets/images/P27-bias-set.jpg" caption="I had to take the heatsink off the chassis because the bridge rectifier heatsink was in the way of the bias adjustment pot. Oops. The heatsink is quite large (just under 0.5&#176;C/W) and took ages to stabilise during setting." %}
...
{% include image.html url="/assets/images/P27-front-blank.jpg" caption="Like a glove. Again :)" %}
...
{% include image.html url="/assets/images/P27-top-down1.jpg" caption="This is the first time I've bothered to use those little Molex connectors for running wires in a project. Usually I just solder them together. While it is fiddly to do, it's well worth it for the ability to quickly and easily take it apart and put it back together later." %}

{% include image.html url="/assets/images/P27-first-test.jpg" caption="First test of the amp as a complete system. My housemates were just going to bed at the time, so the 'master' volume control on the far right is turned right down :)" %}
...
{% include image.html url="/assets/images/P27-3wres.jpg" caption="Not really necessary, but it made me feel better, so..." %}
...
{% include image.html url="/assets/images/P27-complete-front.jpg" caption="'Mordor Enterprises' is an old in-joke that I tend to stick into web forms that force me to enter a business name." %}


{% include image.html url="/assets/images/P27-complete.jpg" caption="It's got a retro, almost '60s look to it. If you get the settings right, you can get a nice '60s sound from it as well." %}


{% include image.html url="/assets/images/P27-complete-side.jpg" caption="The vent holes in the sides were covered with copper mesh to match the front panel. Looks nice and keeps inquisitve fingers away from the mains." %}

{% include image.html url="/assets/images/P27-complete-rear.jpg" caption="Added a couple of labels to the rear detailing the fuse rating and minimum load impedance." %}
